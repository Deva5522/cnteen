...
const UserDashboard = () => {
    const { user, logout, updateLocalWallet, updateUserPreferences, updateUserLoyalty } = useAuth();
                            ...
                            <div style={{ marginBottom: '1.5rem', borderBottom: '1px solid var(--border)', paddingBottom: '1.5rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem' }}>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            const currentLoyalty = user?.loyalty || { points: 0, totalSpent: 0, badge: 'Bronze', birthday: '' };
                                            updateUserLoyalty({ ...currentLoyalty, birthday: tempBirthday });
                            ...
                            <div className="card">
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        const res = placeOrder(method, pickup);
                                        if (res.success) {
                                            setActiveTab('orders');
                                            alert(res.message);
                                            // Reset States
                    ...
                    <div style={{
                        ...
                        <div className="card" style={{ maxWidth: '300px', width: '90%', textAlign: 'center', animation: 'fadeIn 0.3s' }}>
                            ...
                            <div style={{ backgroundColor: 'var(--bg-dark)', padding: '0.5rem', borderRadius: '0.5rem', fontSize: '0.8rem', wordBreak: 'break-all', marginBottom: '1rem' }}>
                                https://canteen.app/join/{Math.random().toString(36).substring(7)}
                            </div>
